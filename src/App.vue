...
const projectsList = ref([
	...
	{
		title: 'Light',
		summary: 'Visualising sound through coloured light.',
...
<template>
	...
	<main>
		...
		<PageContent id="portfolio" :text="headings[1]">
			<h3>Portfolio</h3>
			<h4>It all started with a few hobbyist Minecraft projects. Here is a selection of my proudest work (so far).</h4>
			<p>My projects range from websites to Discord bots. These are projects that I have completed in my free time when I am not working on any major projects or assignments, and was looking to experiment with new libraries and frameworks.</p>
